...
<div class="main_page">
            ...
            <div class="inquiry_form">
                <form action="<?php echo G5_URL;?>/page/inquiry_update.php" method="post" onsubmit="return fninquiry();">
                    ...
                    <div class="cancel_info">
                        <h2 style="font-size:20px;">사전예약 신청이 마감되었습니다.</h2>
                    </div>
                    ...
                    <table>
                        <tr>
                            <td colspan="2" >
                                <input type="submit" value="신청마감" disabled>
                            </td>
                        </tr>
                    </table>
                </form>
    ...
    <section class="main_page5 main_190822" id="menu8">
        <div class="width-fixed">
            <div class="main_title">
                <h2 style="border-bottom:none;"><img src="<?php echo G5_IMG_URL;?>/nanta_txt_e.png" alt=""></h2>
            </div>
            <div class="gold_title">
                <img src="<?php echo G5_IMG_URL;?>/nanta_title_e.png" alt="">
            </div>
            <div class="page_info">
                1회당 참여인원 <span>150명</span>, 사전접수 <span style="color:#ef5423;">80명</span> 현장접수 <span style="color:#ff6e00;">70명</span>으로 선착순 신청자에 한에 이벤트를 참가하실 수 있습니다.
            </div>
            <div class="inquiry_form inquiry_form_190822">
                <form action="<?php echo G5_URL;?>/page/inquiry_update2.php" method="post" onsubmit="return fninquiry2();">
                    <table>
                        ...
                        <!--<tr>
                            <td colspan="2" class="last">
                                <img src="<?php /*echo G5_IMG_URL;*/?>/nanta_infos_e.png" alt="">
                            </td>
                        </tr>-->
                    </table>
                    <div class="cancel_info">
                    ...
                    <!--<div class="price_info">
                        <img src="<?php /*echo G5_IMG_URL;*/?>/nanta_price_info_e0826.png" alt="">
                    </div>-->
                    <table>
                        <tr>
                            <td colspan="2" >
					...
					<div class="question_info">
						<img src="<?php echo G5_IMG_URL;?>/nanta_tell.png" alt="">
					</div>
                </form>
            </div>
        </div>
