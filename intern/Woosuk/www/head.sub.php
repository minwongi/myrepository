...
<?php
if (G5_IS_MOBILE) {
    //echo '<meta name="viewport" content="width=device-width,initial-scale=1.0,minimum-scale=1,maximum-scale=1,user-scalable=no">'.PHP_EOL;
...
if (defined('G5_IS_ADMIN')) {
    ...
    echo '<link rel="stylesheet" href="'.run_replace('head_css_url', G5_CSS_URL.'/style.css?ver='.G5_CSS_VER, G5_URL).'">'.PHP_EOL;
}
?>
<!--[if lte IE 8]>
